 ...
 *
 * OWNER: Architect. Money rounding lives here — see agents/TEAM.md escalation rule.
 *
 ...
 */
import { Decimal, ZERO, add, fmt, money, mul, toPaisa, type Money } from "./money";
import type { DpsMonth, DpsResult } from "./types";
...
export function monthsToReachPlain(
  ...
  return goal.dividedBy(contribution).ceil().toNumber();
}
